"""Static-site generator for *The Shape of Statistical Theory*.
...
# The glossary appendix is generated from glossary.py rather than from a content
# file or an outline stub; build.py special-cases this slug when rendering.
GLOSSARY_SLUG = "glossary"

BOOK_TITLE = "The Shape of Statistical Theory"
BOOK_SUBTITLE = "How the pieces of theoretical statistics fit — distributions, estimation, risk, and regularization, from intuition up."
...
# The book's canonical address, e.g. "https://zorian15.github.io/shape-of-statistical-theory".
...
<meta name="apple-mobile-web-app-title" content="Stat Theory">
<meta name="description" content="A textbook on how the core ideas of theoretical statistics fit together.">
"""
...
def quiz_section_html(slug: str) -> str:
    ...
    return (
        ...
        '<p class="quiz-intro">A few questions to test the ideas from this '
...
def sidebar_html(active_slug: str) -> str:
    ...
    parts.append(
        '<a class="book-brand" href="index.html">The Shape of<br>Statistical Theory'
...
<img class="landing-cover" src="assets/cover.svg" width="640" height="960"
  alt="Cover illustration for The Shape of Statistical Theory.">
<div>
